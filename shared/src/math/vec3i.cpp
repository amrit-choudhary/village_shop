...
float ME::Math::Vec3i::Length() const {
    return std::sqrt(x * x + y * y + z * z);
}

Vec3 ME::Math::Vec3i::Normalised() const {
    float len = Length();
    if (len > 0) {
...
Vec3i ME::Math::Vec3i::NormalisedInt() const {
    float len = Length();
    if (len > 0) {
...
Vec3i ME::Math::Vec3i::operator-() const {
    return Vec3i{-x, -y, -z};
}

Vec3i& ME::Math::Vec3i::operator+=(const Vec3i& b) {
    x += b.x;
    y += b.y;
    z += b.z;
    return *this;
...
int ME::Math::Vec3i::Dot(const Vec3i& a, const Vec3i& b) {
    return (a.x * b.x + a.y * b.y + a.z * b.z);
}

Vec3i ME::Math::Vec3i::Cross(const Vec3i& a, const Vec3i& b) {
    return Vec3i{a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x};
}

Vec3i ME::Math::operator+(const Vec3i& a, const Vec3i& b) {
...
bool ME::Math::operator==(const Vec3i& a, const Vec3i& b) {
    return (a.x == b.x && a.y == b.y && a.z == b.z);
}
