...
static std::unordered_map<uint16_t, KeyCode> KeyCodeMap = {
    {13, KeyCode::W},       {1, KeyCode::S},        {0, KeyCode::A},        {2, KeyCode::D},

    {123, KeyCode::LArrow}, {124, KeyCode::RArrow}, {126, KeyCode::UArrow}, {125, KeyCode::DArrow}};
...
void InputManagerMac::StartEventLoop() {
    ...
    CFMachPortRef eventTap =
        CGEventTapCreate(kCGSessionEventTap, kCGHeadInsertEventTap, CGEventTapOptions::kCGEventTapOptionDefault,
                         eventMask, InputCallback, NULL);
