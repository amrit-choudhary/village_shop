...
ID3D12RootSignature* ME::RootSigDx::CreateRootSignature2DUIText(ID3D12Device* device) {
    if (!device) return nullptr;
...
ID3D12RootSignature* ME::RootSigDx::CreateRootSignature2DUISprite(ID3D12Device* device) {
    if (!device) return nullptr;
