...
// #import "../platform/metal_view_mac.h"
...
//     GameView* myView = [[GameView alloc] initWithFrame:frame device:(id<MTLDevice>)device];

//     [myView setColorPixelFormat:MTLPixelFormatBGRA8Unorm_sRGB];
//     [myView setClearColor:MTLClearColorMake(0.01, 0.01, 0.01, 1.0)];
//     [myView setDepthStencilPixelFormat:MTLPixelFormatDepth32Float];
//     [myView setClearDepth:1.0];
//     [myView setDelegate:viewDelegate];
//     [myView setPaused:NO];
//     [myView setEnableSetNeedsDisplay:NO];

//     // Create GameMain.
//     viewDelegate = new GameMain(device, myView);

//     myView->setDelegate(viewDelegate);
//     // Configure MTKView for continuous drawing loop
//     myView->setPaused(false);                 // Ensure the delegate methods are called
//     myView->setEnableSetNeedsDisplay(false);  // Use internal timer for continuous redraw
